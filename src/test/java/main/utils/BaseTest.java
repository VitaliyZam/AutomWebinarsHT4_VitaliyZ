...
import main.utils.logging.EventHandler;
...
public abstract class BaseTest {
    ...
    protected static final ProductData product = ProductData.generate();
    ...
    @DataProvider(name = "admCredentials")
    public Object[][] provideAdmCreds() {
        return new Object[][]{
